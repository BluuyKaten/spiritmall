package com.wj.spiritmall.spiritmall.thirdparty.controller;
...
import java.util.*;
    ...
    public class OssController {
        ...
        @Value("${spring.cloud.oss.endpotint}")
        private String endpoint;
        @Value("${spring.cloud.oss.bucket}")
        private String bucket;

        //OSS基础信息 替换为实际的 bucket 名称、 region-id、host。
        String region = "cn-guangzhou";
        String host = "http://oss-cn-guangzhou.aliyuncs.com";
        ...
        public static AssumeRoleResponseBody.AssumeRoleResponseBodyCredentials getCredential() throws Exception {
            ...
            com.aliyun.sts20150401.models.AssumeRoleRequest assumeRoleRequest = new com.aliyun.sts20150401.models.AssumeRoleRequest()
                    ...
                    .setRoleSessionName("Spiritmall");// 自定义会话名称
